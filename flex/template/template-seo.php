		...
		<section class="seo-plan section" id="top">
			<div class="container">
				...
				<div class="seo-plan__container">
					...
					<p class="sub-title wow bounceInUp" data-wow-duration="2s">теперь о бизнесе</p>
					<h2 class="wow bounceInUp" data-wow-duration="2s">наши проекты решают <br>ряд бизнес задач</h2>

					<div class="site-plan__list">

						<div class="seo-plan__item wow bounceInUp" data-wow-duration="2s">
							<h3>ПРОДВИЖЕНИЕ <br>САЙТА</h3>
							<p>в ТОП поисковых систем с <br>помощью уникальных <br>статей</p>
						</div>
						
						<div class="seo-plan__item wow bounceInUp" data-wow-duration="2.2s">
							<h3>составление <br>семантического <br>ядра, </h3>
							<p>на основе которого <br>строится поисковый <br>механизм</p>
						</div>

						<div class="seo-plan__item wow bounceInUp" data-wow-duration="2.4s">
							<h3>Бесплатная <br>установка </h3>
							<p>и настройка SEO <br> сервиса и описание <br>главных страниц </p>
						</div>

						<div class="seo-plan__item wow bounceInUp" data-wow-duration="2.6s">
			...
			<div class="container">
				<div class="seo-price__container">
					...
					<div class="seo-price__list">
						<div class="seo-price__item wow bounceInUp" data-wow-duration="2s">
							<h3>эконом</h3>
						...
						<div class="seo-price__item wow bounceInUp" data-wow-duration="2.2s">
							<h3>стандарт</h3>
						...
						<div class="seo-price__item wow bounceInUp" data-wow-duration="2.4s">
							<h3>Премиум</h3>
